...
function CreatingStoryPage() {
    ...
    const onSubmitPost = async(e) => {
        ...
        formData.append('storyMedia', image);
        ...
        try{
            setCaption('');
            const response = await axios.post('http://localhost:3000/story', formData, {
                headers: {
    ...
    return(
        <div className="w-[100%] h-[100%] flex">
            ...
            <div className="w-[80%] h-[100%] bg-[#f5f5f5] rounded-[45px] border-2 px-8 py-5">
                ...
                <div className="mb-8">
                    <h1 className="w-[100%] h-[10%] text-2xl font-bold text-gray-500">Create Your New Story</h1>
                </div>
                ...
                {!isLoadding && <div className="w-[70%] h-[35%] flex gap-5 ">
                                    <input
                                        type="text"
                                        placeholder="Caption for your story"
                ...
                {!isLoadding && <p className="text-xs text-gray-500">*Your story will be deleted automatically after 24 hours</p>}

                {isLoadding &&  <div className="w-[70%] h-[35%] flex gap-5 justify-center items-center">
                                    <div>Uploading your story...</div>
